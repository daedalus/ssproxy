...
def proxy_server():
    ...
    from src.ssproxy.server import ProxyServer
...
class TestConfig:
    ...
    def test_upstream_proxy_config(self) -> None:
        from src.ssproxy.config import UpstreamAuth, UpstreamProxy

        auth = UpstreamAuth(username="user", password="pass")
        upstream = UpstreamProxy(
            enabled=True, host="proxy.example.com", port=8080, auth=auth
        )
    ...
    def test_load_config_file(self, tmp_path) -> None:
        from src.ssproxy.config import load_config
...
class TestProxyHandler:
    def test_basic_http_request(self, proxy_server, mock_server) -> None:
    ...
    def test_http_request_with_body(self, proxy_server, mock_server) -> None:
        client = socket.socket()
        client.connect(("127.0.0.1", 19999))
    ...
    def test_proxy_returns_502_on_connection_failure(self) -> None:
        from src.ssproxy.config import ProxyConfig
        from src.ssproxy.logging_utils import logger
        from src.ssproxy.server import ProxyServer
...
class TestLogging:
    def test_colored_logger_output(self, capsys) -> None:
        from src.ssproxy.logging_utils import ColoredLogger
    ...
    def test_logger_disabled(self, capsys) -> None:
        from src.ssproxy.logging_utils import ColoredLogger
    ...
    def test_logger_plain_mode(self, capsys) -> None:
        from src.ssproxy.logging_utils import ColoredLogger
    ...
    def test_cli_help(self) -> None:
        ...
        from src.ssproxy.__main__ import create_parser
    ...
    def test_cli_port_override(self) -> None:
        ...
        from src.ssproxy.__main__ import apply_cli_overrides
        from src.ssproxy.config import ProxyConfig
    ...
    def test_cli_upstream_format(self) -> None:
        from src.ssproxy.__main__ import create_parser
...
class TestProxyServer:
    ...
    def test_server_binds_to_port(self) -> None:
        from src.ssproxy.config import ProxyConfig
        from src.ssproxy.logging_utils import logger
        from src.ssproxy.server import ProxyServer
