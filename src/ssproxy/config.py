...
from .acl import ACLConfig, load_acl_from_dict
...
class UpstreamProxy:
    ...
    def to_dict(self) -> dict[str, str | int | bool | dict[str, str | bool]]:
        return {
            "enabled": self.enabled,
            "host": self.host,
            "port": self.port,
...
class ProxyConfig:
    ...
    def to_dict(self) -> dict[str, str | int | bool | dict[str, Any]]:
        return {
            "host": self.host,
            "port": self.port,
...
def load_config(config_path: str | None = None) -> ProxyConfig:
    ...
    acl_config = load_acl_from_dict(acl_data)
...
def save_config(config: ProxyConfig, config_path: str) -> None:
